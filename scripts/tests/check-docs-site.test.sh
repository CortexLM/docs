...
# A page no navigation entry reaches still syncs to FernDesk and still gets
# indexed, but no reader can navigate to it. That is how the tree accumulated a
# second hub for every product.
