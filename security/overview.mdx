...
keywords: ["privacy", "data", "cookies", "storage", "export", "delete"]
---
...
<Frame caption="The CLI asking before it runs an install: run once, always allow in this project, edit the command, or decline.">
  <img src="/images/cli/runtime/40x12/permission-prompt.png" alt="Cortex CLI approval prompt rendered in a 40 by 12 terminal" />
</Frame>
