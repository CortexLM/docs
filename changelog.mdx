---
title: "Changelog"
description: "What shipped in Cortex Chat, Cortex Code, Cortex Bot, and the Cortex CLI — dated, with a link to the surface it changed."
...
An entry names a change the product already ships, with a date, and links the surface. Product previews stay labelled as previews. An inference Platform API is not announced here, because it has no public endpoints yet.
