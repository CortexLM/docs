...
<Update label="8 September 2026" description="Cortex CLI 0.1.10">
- The README demo is regenerated from the shipped TUI on a green macOS desktop, with a pointer that walks the composer, the slash palette, `/model`, and a Shell tool row. The stills on the [CLI pages](/cli) come from this render.
