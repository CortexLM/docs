...
- [Computer](/bot/computer) — the guest states behind Connecting and Stream Unavailable.
- [Approvals](/bot/approvals) — why a parked step waits.
- [Routines](/bot/routines) — local weekday timing.
