...
Cortex ships two desktop apps because the two jobs are different. The [Cortex desktop app](/getting-started/downloads) carries **Chat and Code**. The **Cortex Bot desktop app** is built around bots: its sidebar is **agents, routines, and channels**, and it adds **This PC** as a host for a bot's computer. It does not carry Chat or Code.
...
| Need | App |
| --- | --- |
| Chat, plus Code on This PC or SSH | [Cortex desktop](/getting-started/downloads) |
