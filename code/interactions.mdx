...
description: "Choose how much a Code turn may change. Ask reads and explains, Plan proposes, Agent edits and runs. The choice rides on the turn."
keywords: ["Ask", "Plan", "Agent", "modes", "permissions"]
---
...
<Frame caption="The CLI's slash palette in a small terminal: /plan drafts a plan before writing, /goal keeps a long-horizon objective.">
  <img src="/images/cli/runtime/40x12/slash-palette.png" alt="Cortex CLI slash palette showing /plan and /goal in a 40 by 12 terminal" />
</Frame>
