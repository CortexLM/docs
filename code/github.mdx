...
description: "Cortex Code reaches repositories through Connect GitHub — on Code Home, in the repository picker, and under Settings → Integrations."
keywords: ["repository", "repos", "connection", "Reconnect"]
---
