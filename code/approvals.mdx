...
<Frame caption="Interface preview">
  <img src="/images/product/code-diff-review-light.webp" alt="A Code session with pending file changes, a proposed diff, and controls to reject, request edits, or approve." width="3360" height="2240" loading="lazy" />
</Frame>
