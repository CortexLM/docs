...
The Cloud is the only host in the browser. **This PC** and **SSH** exist on the desktop app and the CLI — see [Hosts](/code/desktop). Those hosts require an already connected Code session; Cortex never silently substitutes the Cloud for a host you chose.
