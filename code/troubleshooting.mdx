...
| This PC or SSH is refused in the CLI | Those hosts need an already connected Code session | Resume a session that has the host, or unset `CORTEX_COMPUTER`. See [Hosts](/code/desktop) |
