...
<Frame caption="Interface preview">
  <div className="block dark:hidden">
    <img src="/images/product/code-home-light.webp" alt="The first-run Cortex Code home on macOS with a task composer, repository chooser, and GitHub connection prompt." width="3360" height="2240" loading="lazy" />
  </div>
  <div className="hidden dark:block">
    <img src="/images/product/code-home-dark.webp" alt="The first-run Cortex Code home on macOS with a task composer, repository chooser, and GitHub connection prompt." width="3360" height="2240" loading="lazy" />
  </div>
</Frame>
