...
description: "GitHub pull-request review without pasting a diff. Cortex reads the change in place and posts a check run that stays failed when it fails."
keywords: ["pull request review", "check run", "GitHub App"]
---
