...
keywords: ["tutorial", "first run", "getting started"]
---
...
- [Install](/cli/install) — checksums, version pins, and channels.
- [Sign in](/cli/sign-in) — the browser flow, device codes, and CI keys.
- [Modes and permissions](/cli/modes-and-permissions) — decide how much the agent may do.
- [CLI troubleshooting](/cli/troubleshooting) — the terminal.
