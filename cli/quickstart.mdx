...
<Frame caption="A turn in flight: the status line says what the agent is doing, how long it has run, and that Esc interrupts. The composer accepts a follow-up to queue.">
  <img src="/images/cli/working.png" alt="Cortex CLI working in macOS Terminal — Working, wiring the limiter into completions; Add a follow-up, Enter to queue" />
</Frame>
