...
<Frame caption="An active goal: the composer border reads Agent — Goal · 2/8 after the kickoff turn “ship the rate limiter and prove it with tests”.">
  <img src="/images/cli/runtime/120x40/goal-chip-active.png" alt="Cortex CLI composer with the Goal · 2/8 chip on its border" />
</Frame>
...
<Frame caption="Evidence-complete: the chip reads Goal · done and auto-continuation stops.">
  <img src="/images/cli/runtime/120x40/goal-chip-done.png" alt="Cortex CLI composer with the Goal · done chip on its border" />
</Frame>
