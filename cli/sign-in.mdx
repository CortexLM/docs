...
<Frame caption="The inline sign-in picker: Continue with browser, or Paste an API key. Numbered rows, arrow keys to select, Enter to confirm.">
  <img src="/images/cli/runtime/login.png" alt="Welcome to Cortex CLI — How would you like to log in? Continue with browser or Paste an API key" />
</Frame>
...
<Frame caption="Waiting for the browser: the code to enter, and the URL to visit if the browser did not open. Esc cancels.">
  <img src="/images/cli/runtime/login-waiting.png" alt="Waiting for browser authentication with a device code shown" />
</Frame>
