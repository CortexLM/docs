---
title: "Sign in"
description: "cortex login opens the browser flow; a device code covers machines without one; API keys cover CI. Credentials live in your OS keyring."
keywords: ["login", "authentication", "API key", "device code", "token"]
---
