...
<Frame caption="/mcp: each server with its tool count and state — connected, authenticating, or failed with r to reconnect.">
  <img src="/images/cli/runtime/mcp-servers.png" alt="Cortex CLI MCP server manager listing four servers and their connection state" />
</Frame>
...
<Frame caption="/skills: searchable, each with its description and whether it comes from the project or your user directory.">
  <img src="/images/cli/runtime/skills.png" alt="Cortex CLI skills picker listing project and user skills" />
</Frame>
...
<Frame caption="/plugins: version, enabled state, and what each plugin adds — for example a /review command.">
  <img src="/images/cli/runtime/plugins.png" alt="Cortex CLI plugins manager listing installed plugins" />
</Frame>
