...
keywords: ["setup", "download", "upgrade", "update", "checksum"]
---
...
<Frame caption="A fresh install: Welcome to Cortex, the coding agent CLI · v0.1.10 · / commands · @ files · ! shell · & cloud, with the empty Agent composer and the token counter at 0 / 500K.">
  <img src="/images/cli/runtime/120x40/welcome-cortex.png" alt="Cortex CLI welcome splash for v0.1.10 with the empty composer" />
</Frame>
