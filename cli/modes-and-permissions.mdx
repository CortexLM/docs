...
description: "Agent / Plan / Ask, the Spec lock, approval prompts, the sandbox, the permission table, and the model picker's effort radios."
keywords: ["Agent", "Plan", "Ask", "sandbox", "approvals", "autonomy"]
---
