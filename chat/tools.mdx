...
description: "Built-in Chat tools, connected apps under Customize → Connectors, GitHub in Settings → Integrations, and MCP servers."
keywords: ["Customize", "Connectors", "integrations", "plugins", "MCP", "connected apps"]
---
...
- [How Chat works](/chat/how-it-works) — how tools enter a turn.
- [Connect GitHub](/code/github) — the repository connection, which lives in Code.
- [Cortex Security](/code/security) — the third GitHub install, for pull-request review.
- [Extend the CLI](/cli/extend) — MCP servers for the terminal agent.
