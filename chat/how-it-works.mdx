...
description: "A Chat turn is one tool-calling loop: the model asks for tools, Chat runs them, results flow back, and the loop ends when the model stops."
keywords: ["tool loop", "context", "compaction", "rounds"]
---
