...
There is no public inference API on this site. Model names here are product names inside Cortex Chat, not endpoints. See [Public API](/api/overview).

## Related

- [How Chat works](/chat/how-it-works) — tokens as they arrive, and the tool loop.
