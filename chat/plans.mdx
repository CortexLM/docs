...
keywords: ["Planning", "task list", "checklist", "steps"]
---
...
- [Projects](/chat/projects) — instructions that apply to every chat in them.
- [Canvases](/chat/canvases) — a document beside one conversation.
- [Deep Research](/chat/deep-research) — the research plan, which is not a task list.
- [CLI goals](/cli/goal) — a long-horizon objective in the terminal.
