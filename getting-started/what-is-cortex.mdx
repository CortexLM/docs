...
description: "Three products and a CLI behind one account on cortex.foundation — Chat, Code, Bot, and the Cortex CLI."
image: "/images/banners/getting-started.png"
---

Cortex is built by the Cortex Foundation, a research-first lab. The products share one account, one domain, and one set of models. Use **Chat** for conversation and research, **Code** for a repository, **Bot** for an always-on teammate with its own computer, and the **CLI** to drive Code from a terminal.

## The products

| Product | Where you use it | Who can open it | Guide |
| --- | --- | --- | --- |
| **Cortex Chat** | The web app, and the Cortex desktop app | Anyone — guests included | [Chat](/chat) |
| **Cortex Code** | The web app, the Cortex desktop app, and the CLI | Signed-in members | [Code](/code) |
| **Cortex Bot** | The web app and the Bot desktop app | Signed-in members | [Bot](/bot) |
| **Cortex CLI** | Your terminal | Signed-in members | [CLI](/cli) |
...
Chat does not run Code's workspace shell or Bot's computer. Code sessions are a timeline of work, not a chat transcript. Each product keeps its own shape on purpose — see [How Chat works](/chat/how-it-works), [How Code works](/code/how-it-works), and [How Bot works](/bot/how-it-works).
...
| `status.cortex.foundation` | Live component health and incidents |
