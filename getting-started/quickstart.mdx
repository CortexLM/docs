...
<Steps>
  ...
  <Step title="Pick your next surface">
    ...
    | --- | --- | --- |
    | **Chat** | Projects, Library, canvases, Deep Research | [Chat](/chat) |
    | **Code** | Connect GitHub and start a session on a repository | [Code](/code) |
    | **Bot** | Create a bot and give it a task on its computer | [Bot](/bot) |
    | **CLI** | Run `cortex` in a project directory | [CLI](/cli) |
  </Step>
</Steps>
