...
keywords: ["errors", "problems", "fixes", "not working", "support"]
---
...
- [Chat troubleshooting](/chat/troubleshooting) — turns, files, models, and connections.
- [Code troubleshooting](/code/troubleshooting) — gates, Reconnect, and runtimes.
- [Bot troubleshooting](/bot/troubleshooting) — computers, parked steps, and routines.
