...
keywords: ["install", "apps", "desktop", "releases"]
---
...
- [Desktop app](/getting-started/desktop) — what This PC and SSH add for Code.
- [Bot desktop](/bot/desktop) — the app built around agents, routines, and channels.
- [Design desktop](/design/desktop) — the working UI for canvases.
- [Install the CLI](/cli/install) — checksums, version pins, and channels.
