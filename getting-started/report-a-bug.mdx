...
This page covers what to check before you file, where the dialog opens from, what to
...
These entry points open the same **Report a bug** dialog:
...
The Settings entry is permanent. Dismissing the banner does not remove it.
...
<CardGroup cols={2}>
  ...
  <Card title="A security weakness" icon="shield" href="/bounty/report">
    Eligible participants can add a filed report to Cortex Bounty from its receipt. Linking a
    hotkey, programme availability and scoring rules determine participation and rewards.
  </Card>
</CardGroup>
