...
keywords: ["guest", "sign in", "membership", "plan"]
---
...
- [Plans and quotas](/getting-started/plans) — what each plan includes and how limits behave.
- [Settings](/getting-started/settings) — theme, language, models, privacy, billing.
