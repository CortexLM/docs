...
keywords: ["pricing", "quotas", "limits", "billing", "Free", "Go", "Plus", "Pro"]
---
...
- [Accounts](/getting-started/accounts) — guest versus member, and what each unlocks.
- [Models and thinking](/chat/models) — which models a plan can serve.
- [Image generation](/chat/images) — the `images_per_day` window.
- [CLI troubleshooting](/cli/troubleshooting) — quota messages in the terminal.
