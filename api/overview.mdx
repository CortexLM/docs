...
**Sign in at [cortex.foundation](https://cortex.foundation).** The CLI and desktop app use the same account. This site does not document login, sessions, refresh tokens, or identity-provider wire protocol.
...
- Authentication, session cookies, device codes, or OAuth internals
